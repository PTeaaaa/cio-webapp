...
export default function ListPeopleTable() {
    ...
    const { people, loading, error, placeId } = usePeople();
    ...
    if (people.length === 0) {
        return <div className="text-center py-4 text-gray-500 dark:text-gray-400">ไม่มีข้อมูลบุคคลสำหรับสถานที่นี้</div>;
    }
                    ...
                    <Table>
                        ...
                        <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                            <TableRow>
                                <TableCell
                                    isHeader
                                    className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 lg:hidden"
                                >
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="w-12 h-12 overflow-hidden rounded-full">
                                                <Image
                                                    width={40}
                                                    height={40}
                                                    src={order.imageUrl || "/images/default/default-avatar.jpg"}
                                                    alt={order.name}
